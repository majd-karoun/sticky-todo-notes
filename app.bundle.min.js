(()=>{const at=["#f0e68c","#98ff98","#ff7eb9","#7afcff","#FE8801","#ec0c39","#AF65EF","#ffd700","#C1C1C1","#FFFFFF"],M={colors:{default:"#1a1a1a",current:"#1a1a1a",available:["#1a1a1a","#500000","#004000","#000050","#10253F","#400040"]},patterns:{default:"none",current:"none"}};let _=[];let V=null,Jt=null,ft=!1,Z=null,yt=0,ht=0,x=[],rt=!1,Vt=0,Zt=0,F=[];const K={},J={},z={};let R=1e3;K[1]={x:window.innerWidth/2-100,y:window.innerHeight/2-75};J[1]=at[0];let u=1,L=1,G=!1;const tt=9,Q="stickyNotes_active",Gt="stickyNotes_deleted",Qt="stickyNotes_boardCount",te="stickyNotes_zIndexes",ee=()=>{G=window.innerWidth<=768,G&&u!==1&&typeof N=="function"&&N(1)},p=t=>parseInt(String(t).replace("px",""))||0,Te=(t,e)=>{const o=Math.random()*10-5;let s=t+o,a=e+70;const n=5,r=window.innerWidth-200,i=window.innerHeight-300;a>i&&(a=50,s=t+250,s>r&&(s=n+50,a=50));const l=Math.min(Math.max(s,n),r),f=Math.min(Math.max(a,n),window.innerHeight-100);return{x:l,y:f}},Me=t=>{if(t.startsWith("rgba")){const o=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return o?{r:parseInt(o[1]),g:parseInt(o[2]),b:parseInt(o[3])}:null}t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(o,s,a,n)=>s+s+a+a+n+n);const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null},Bt=(t,e)=>{try{localStorage.setItem(t,JSON.stringify(e))}catch(o){console.error(`Failed to save to localStorage (${t}):`,o)}},X=()=>{const t=document.querySelector(`.board[data-board-id="${u}"]`);if(!t)return;const e=Array.from(t.querySelectorAll(".sticky-note")).map(o=>({text:o.querySelector(".sticky-content").innerHTML,color:o.style.backgroundColor,x:o.style.left,y:o.style.top,width:o.style.width||"200px",height:o.style.height||"150px",isBold:o.querySelector(".sticky-content").classList.contains("bold"),noteId:o.dataset.noteId,zIndex:o.style.zIndex||1}));Bt(`${Q}_board_${u}`,e),typeof Y=="function"&&Y()},St=()=>Bt(Gt,_),oe=()=>localStorage.setItem(Qt,L.toString()),ne=()=>Bt(`boardStyles_board_${u}`,{color:M.colors.current,pattern:M.patterns.current}),se=()=>{const t=document.getElementById("shortcutIcon");if(!t)return;const e=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl";t.innerHTML=e,t.className="shortcut-icon focus-hint"},ae=()=>{const t=document.querySelector(".note-input textarea");if(!t)return;const e=document.getElementById("shortcutIcon"),o=()=>{if(!e)return;const s=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl",a=t.value.trim();e.innerHTML=a?`${s}+\u21B5`:s,e.classList.toggle("focus-hint",!a),e.classList.toggle("enter-hint",a)};t.addEventListener("focus",()=>{o(),t.style.height="50px",requestAnimationFrame(()=>t.style.height="200px"),t.addEventListener("input",o)}),t.addEventListener("blur",()=>{se(),t.style.height="200px",requestAnimationFrame(()=>t.style.height="50px"),t.removeEventListener("input",o)}),document.addEventListener("mousedown",s=>{!s.target.closest(".note-input")&&document.activeElement===t&&t.blur()})},Ht=(t,e=null)=>{try{return JSON.parse(t)}catch(o){return console.error("Failed to parse JSON data:",o),e}},qe=()=>{const t="stickyNotes_storageCleanupPerformed";if(!localStorage.getItem(t))try{console.log("Performing one-time localStorage cleanup...");const e=[];for(let o=0;o<localStorage.length;o++){const s=localStorage.key(o);s&&(s.startsWith("stickyNotes_")||s.startsWith("boardColor_")||s.startsWith("boardPattern_")||s.startsWith("boardStyles_")||s.startsWith("emojiStickers_")||s.startsWith("daysPatternStartDate_")||s.startsWith("emojiUsageOrder"))&&e.push(s)}e.forEach(o=>{localStorage.removeItem(o)}),console.log(`Cleaned up ${e.length} localStorage items`),localStorage.setItem(t,"true")}catch(e){console.error("Error during localStorage cleanup:",e),localStorage.setItem(t,"true")}},$e=()=>{try{qe(),ee(),typeof zt=="function"&&zt();const t=localStorage.getItem(Qt);if(t){const o=parseInt(t);if(!isNaN(o)&&o>0){L=Math.min(o,tt);for(let s=2;s<=L;s++)typeof Nt=="function"&&Nt(s)}}typeof bt=="function"&&bt();for(let o=1;o<=L;o++){const s=localStorage.getItem(`${Q}_board_${o}`);if(s){const a=Ht(s,[]);Array.isArray(a)&&a.forEach(n=>{if(n&&typeof n=="object"&&n.text&&(K[o]={x:p(n.x),y:p(n.y)},J[o]=n.color||at[0],typeof gt=="function")){const r=gt(n.text,n.color||at[0],p(n.x),p(n.y),!0,n.width||"200px",n.height||"150px",n.isBold||!1,o);r&&n.noteId&&(r.dataset.noteId=n.noteId,z[n.noteId]?(r.style.zIndex=z[n.noteId],z[n.noteId]>R&&(R=z[n.noteId])):n.zIndex&&!isNaN(parseInt(n.zIndex))&&(r.style.zIndex=n.zIndex,z[n.noteId]=parseInt(n.zIndex),parseInt(n.zIndex)>R&&(R=parseInt(n.zIndex))))}})}typeof dt=="function"&&dt(o)}typeof N=="function"&&N(1);const e=localStorage.getItem(Gt);if(e){const o=Ht(e,[]);Array.isArray(o)&&(_=o,typeof et=="function"&&et())}["updateBoardIndicators","updateShortcutHintVisibility"].forEach(o=>{typeof window[o]=="function"&&window[o]()}),se(),ae()}catch(t){console.error("Critical error loading saved data:",t)}},Ne=t=>{t.style.zIndex=++R;const e=t.dataset.noteId;e&&(z[e]=R,re())},re=()=>{try{localStorage.setItem(te,JSON.stringify(z))}catch(t){console.error("Error saving note z-indexes:",t)}},Be=()=>{try{const t=localStorage.getItem(te);t&&(Object.assign(z,JSON.parse(t)),R=Math.max(1e3,...Object.values(z)))}catch(t){console.error("Error loading note z-indexes:",t)}};const zt=()=>{Z=Object.assign(document.createElement("div"),{className:"selection-box"}),Object.assign(Z.style,{display:"none"}),document.body.appendChild(Z)};function Ie(){const t=document.querySelector(".boards-container");document.addEventListener("mousedown",e=>{e.target.closest(".board")&&!e.target.closest(".sticky-note, .note-input, .boards-navigation, .trash-bin, .board-style-button")&&e.preventDefault()}),[["mousedown",Ae],["mousemove",je],["mouseup",De]].forEach(([e,o])=>(e==="mousedown"?t:document).addEventListener(e,o))}function Ae(t){if(t.target.closest(".sticky-note, .note-input, .trash-bin, .boards-navigation, .board-style-button, .emoji-sticker"))return;t.preventDefault();const e=document.querySelector(".note-input textarea");e&&document.activeElement===e&&e.blur(),!t.shiftKey&&Et(),[ft,yt,ht]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),Z.style.cssText=`left:${yt}px; top:${ht}px; width:0; height:0; display:block;`}function je(t){if(!ft)return;t.preventDefault();const[e,o]=[Math.abs(t.clientX-yt),Math.abs(t.clientY-ht)],[s,a]=[Math.min(t.clientX,yt),Math.min(t.clientY,ht)];Z.style.cssText=`left:${s}px; top:${a}px; width:${e}px; height:${o}px; display:block;`,Oe()}const De=()=>{ft&&(ft=!1,document.body.classList.remove("selecting"),Z.style.display="none")};function Oe(){const t=Z.getBoundingClientRect(),e=document.querySelector(`.board[data-board-id="${u}"]`);if(!e)return;const o=(s,a,n)=>{const r=s.getBoundingClientRect(),i=!(r.right<t.left||r.left>t.right||r.bottom<t.top||r.top>t.bottom),l=a.indexOf(s);i?l===-1&&(a.push(s),s.classList.add(n)):!rt&&l!==-1&&(a.splice(l,1),s.classList.remove(n))};e.querySelectorAll(".sticky-note").forEach(s=>o(s,x,"selected"))}const Et=()=>{x.forEach(t=>t.classList.remove("selected")),x=[]};function Re(t){[rt,Vt,Zt]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),F=x.map(e=>({element:e,x:p(e.style.left),y:p(e.style.top),type:"note"})),["mousemove","mouseup"].forEach(e=>document.addEventListener(e,e==="mousemove"?ie:ce))}function ie(t){if(!rt)return;const[e,o]=[t.clientX-Vt,t.clientY-Zt],[s,a,n]=[5,-5,-5],[r,i]=[window.innerWidth-s,window.innerHeight-s];(f=>f.forEach(d=>{const[y,g]=[Math.min(Math.max(d.x+e,a),r-d.element.offsetWidth/4),Math.min(Math.max(d.y+o,n),i-d.element.offsetHeight/4)];Object.assign(d.element.style,{left:`${y}px`,top:`${g}px`})}))(F),x.length>0&&(me(t.clientX,t.clientY),x.length>1&&Ot())}function ce(){if(!rt)return;if(rt=!1,document.body.classList.remove("selecting"),["mousemove","mouseup"].forEach(e=>document.removeEventListener(e,e==="mousemove"?ie:ce)),lt(),!ye().moved){X();for(let e=x.length-1;e>=0;e--)le(x[e])&&x.splice(e,1)}Rt()}let st=[];const _e=100,Wt=50,Xe="#ffd700",Ye=()=>{const[t,e]=[document.getElementById("trashModal"),document.querySelector(".clear-trash-btn")];t&&!t.classList.contains("visible")&&(t.style.display="block",t.classList.add("visible"),requestAnimationFrame(()=>wt())),e&&(e.classList.add("shake-animation"),setTimeout(()=>e.classList.remove("shake-animation"),1e3))},It=t=>{x.includes(t)&&x.length>1?(x.forEach((e,o)=>setTimeout(()=>Mt(e),o*100)),Et()):Mt(t)},Mt=t=>{if(_.length>=_e){!st.includes(t)&&st.push(t),Ye();return}const e=t.querySelector(".sticky-content"),o={text:e.innerHTML,color:t.style.backgroundColor,x:t.style.left,y:t.style.top,width:t.style.width,height:t.style.height,timestamp:new Date().toLocaleString(),isBold:e.classList.contains("bold")};Pe(t),_.unshift(o),St(),et(),He(t)},Pe=t=>{if(!window.noteColumns)return;const e=t.closest(".board");if(!e||!e.matches(".board-pattern-weekdays, .board-pattern-days"))return;const[o,s]=[e.getBoundingClientRect(),t.getBoundingClientRect()],a=Math.min(5,Math.max(0,Math.floor((s.left+s.width/2-o.left)/(o.width/6))));window.noteColumns[a]&&(window.noteColumns[a]=window.noteColumns[a].filter(n=>Math.abs(n.x-p(t.style.left))>1||Math.abs(n.y-p(t.style.top))>1))},He=t=>{const e=document.querySelector(".trash-bin"),o=e.getBoundingClientRect(),s=t.getBoundingClientRect(),a=o.left-s.left+o.width/2-s.width/2,n=o.top-s.top;t.style.setProperty("--throwX",`${a}px`),t.style.setProperty("--throwY",`${n}px`),t.style.animation="paperCrumble 0.5s ease-in forwards",e.style.animation="binShake 0.5s ease-in-out",setTimeout(()=>{t.remove(),e.style.animation="",X(),Y()},500)},le=t=>{const[e,o]=[document.querySelector(".trash-bin").getBoundingClientRect(),t.getBoundingClientRect()];return o.right>e.left&&o.left<e.right&&o.bottom>e.top&&o.top<e.bottom?(It(t),!0):!1},it=()=>{const t=document.getElementById("trashModal");t.classList.toggle("visible")?(t.style.display="block",requestAnimationFrame(()=>wt())):setTimeout(()=>t.style.display="none",300)},wt=()=>{const t=document.querySelector(".deleted-notes-container");t.style.minHeight="200px",t.innerHTML=_.length?_.map((e,o)=>`
            <div class="deleted-note" style="background-color: ${e.color||Xe}">
            ...
            </div>`).join(""):'<div class="empty-state">(Empty)</div>'},ze=t=>{const e=document.querySelectorAll(".deleted-note")[t];e==null||e.classList.add("shrinking"),setTimeout(()=>{const[o]=_.splice(t,1);gt(o.text,o.color,p(o.x),p(o.y),!0,o.width,o.height,o.isBold),St(),et(),wt(),X(),Y()},300)},de=()=>{if(_.length===0){it();return}const t=[...document.querySelectorAll(".deleted-note")].slice(0,6);t.forEach((e,o)=>{e.classList.add("note-deleting"),e.style.animationDelay=`${o*Wt}ms`}),setTimeout(()=>{_=[],St(),et(),wt(),setTimeout(()=>{if(it(),st.length){const e=[...st];st=[],setTimeout(()=>{e.forEach(o=>{o!=null&&o.parentNode&&Mt(o)})},300)}},200)},(t.length?(t.length-1)*Wt+300:0)+100)},et=()=>{document.querySelector(".trash-count").textContent=_.length};document.addEventListener("click",t=>{const e=document.getElementById("trashModal");e!=null&&e.classList.contains("visible")&&t.target===e&&it()});let At=new Set;const jt=()=>`note_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,We=()=>Math.random()*40-20,Fe=(t=xt())=>t.getDay()===0?0:t.getDay()-1;function kt(t){const e=document.getElementById("noteLimitMessage"),o=e==null?void 0:e.querySelector(".transfer-text");o&&(o.textContent=t),e&&(e.classList.add("visible"),setTimeout(()=>e.classList.remove("visible"),3e3))}function Dt(){const t=document.querySelector(".note-input textarea"),e=t.value.trim();if(!e)return;const o=document.querySelector(`.board[data-board-id="${u}"]`),s=Array.from(o.querySelectorAll(".sticky-note")),[a,n,r]=[o.classList.contains("board-pattern-weekdays"),o.classList.contains("board-pattern-days"),s.length===0];if(!a&&!n&&s.length>=30){kt("Maximum notes space reached.");return}const i=s[s.length-1];let{x:l,y:f}=K[u]||{x:0,y:0},d=J[u]||getRandomColor(),y,g;const v=(w,b,q=null)=>{const E=o.offsetWidth/b,C=w*E+10,j=(w+1)*E-210,U=Math.max(C,Math.min(j,C+We())),$=Array.from(o.querySelectorAll(".sticky-note")).filter(c=>c.style.display!=="none"&&c!==q),[A,W]=[w*E,(w+1)*E],P=$.filter(c=>{const[m,h]=[p(c.style.left),p(c.style.left)+200],[S,D]=[Math.max(m,A),Math.min(h,W)];return Math.max(0,D-S)/200>.5});return{positionX:U,columnNotes:P}},k=(w,b)=>{const q=window.innerHeight-300;for(let E=0;E<b;E++){const C=(w+E)%b,{positionX:j,columnNotes:U}=v(C,b);let $=60,A=null;U.forEach(P=>{const c=p(P.style.top);c>=$&&($=c,A=P)});const W=A?$+70:60;if(W<=q)return y=j,g=W,A&&(d=A.style.backgroundColor),!0}return kt("Maximum notes space reached."),!1},I=w=>{let b;const q=w?6:5;if(i){const E=p(i.style.left),C=o.offsetWidth/q;b=Math.floor(E/C),b=Math.max(0,Math.min(b,q-1))}else b=w?Fe():Xt(u)||0;return k(b,q)};if(r)if(a||n){if(I(a)===!1)return}else[y,g]=[Math.max(150,window.innerWidth/4),50];else if(a||n){if(I(a)===!1)return}else if(i&&([l,f,d]=[p(i.style.left),p(i.style.top),i.style.backgroundColor]),{x:y,y:g}=Te(l,f),g<=50){const w=s.filter(b=>Math.abs(p(b.style.left)-y)<150);if(w.length>0){const b=w.map($=>p($.style.top)),[q,E]=[Math.max(...b),Math.min(...b)],C=window.innerHeight-300,[j,U]=[q+200,E-200];if(j<=C)g=j;else if(U>=50)g=U;else{const $=(W,P)=>{const c=window.innerWidth-200;for(let m=W;P>0?m<=c:m>=55;m+=P*250){const h=s.filter(Lt=>Math.abs(p(Lt.style.left)-m)<150);if(h.length===0)return{x:m,y:50};const S=h.map(Lt=>p(Lt.style.top)),[D,ot]=[Math.max(...S),Math.min(...S)],[ut,nt]=[D+200,ot-200];if(ut<=C)return{x:m,y:ut};if(nt>=50)return{x:m,y:nt}}return null},A=$(y+250,1)||$(y-250,-1);if(A)[y,g]=[A.x,A.y];else{kt("Maximum notes space reached.");return}}}}gt(e.replace(/\n/g,"<br>"),d,y,g,!1,"200px","150px",!1,u),[K[u],J[u],t.value]=[{x:y,y:g},d,""],X(),Y()}function gt(t,e,o,s,a=!1,n="200px",r="150px",i=!1,l=u,f=!1){const[d,y]=[document.createElement("div"),jt()];Object.assign(d,{className:"sticky-note",innerHTML:`<div class="sticky-content ${i?"bold":""}" contenteditable="true">${t}</div>
        <div class="note-controls">
            <div class="color-button" style="background-color: ${e}">
                <div class="color-palette">${at.map(v=>`<div class="color-option" style="background-color: ${v}" onclick="changeNoteColor(this, '${v}')"></div>`).join("")}</div>
            </div>
