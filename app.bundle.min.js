(()=>{var De=Object.defineProperty;var Ft=Object.getOwnPropertySymbols;var Ue=Object.prototype.hasOwnProperty,_e=Object.prototype.propertyIsEnumerable;var Wt=(t,e,o)=>e in t?De(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o,Lt=(t,e)=>{for(var o in e||(e={}))Ue.call(e,o)&&Wt(t,o,e[o]);if(Ft)for(var o of Ft(e))_e.call(e,o)&&Wt(t,o,e[o]);return t};const W=new Map,Kt=()=>{Object.entries({trashBin:".trash-bin",statusBar:".status-bar",noteInput:".note-input",selectionBox:".selection-box"}).forEach(([e,o])=>{const s=document.querySelector(o);s&&W.set(e,s)})};window.$=t=>{if(W.has(t)){const e=W.get(t);return e.isConnected?e:(W.delete(t),document.querySelector(t))}return document.querySelector(t)};window.$$=(t,e=!1)=>{if(e&&W.has(t)){const o=W.get(t);return o.every(s=>s.isConnected)?o:(W.delete(t),Array.from(document.querySelectorAll(t)))}return Array.from(document.querySelectorAll(t))};window.$within=(t,e)=>t?t.querySelector(e):null;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Kt):Kt();const ft=new Map;let ot=null;const ee=()=>{ft.forEach(({element:t,styles:e})=>{t.isConnected&&Object.entries(e).forEach(([o,s])=>{o.startsWith("--")?t.style.setProperty(o,s):t.style[o]=s})}),ft.clear(),ot=null},je=()=>{ot||(ot=requestAnimationFrame(ee))};window.AnimationUtils={updateStyles(t,e,o="normal"){var n;if(!t||!e)return;const s=t._batchId||(t._batchId=Math.random().toString(36));ft.set(s,{element:t,styles:Lt(Lt({},(n=ft.get(s))==null?void 0:n.styles),e)}),je()},updatePosition(t,e,o){this.updateStyles(t,{left:`${e}px`,top:`${o}px`})},updateSize(t,e,o){this.updateStyles(t,{width:`${e}px`,height:`${o}px`})},flush(){ot&&(cancelAnimationFrame(ot),ee())}};const Q=new Map,mt=new Map,kt=t=>{if(Q.has(t))try{const e=Q.get(t);localStorage.setItem(t,typeof e=="string"?e:JSON.stringify(e)),Q.delete(t),mt.delete(t)}catch(e){console.warn("Storage save failed:",e)}};window.DebouncedStorage={save(t,e,o="normal"){mt.has(t)&&clearTimeout(mt.get(t)),Q.set(t,e);const s=o==="high"?50:o==="low"?1e3:300;mt.set(t,setTimeout(()=>kt(t),s))},saveHigh(t,e){this.save(t,e,"high")},saveLow(t,e){this.save(t,e,"low")},flush(t){kt(t)},flushAll(){Q.forEach((t,e)=>kt(e))}};window.addEventListener("beforeunload",()=>window.DebouncedStorage.flushAll());const nt=["#f0e68c","#98ff98","#ff7eb9","#7afcff","#FE8801","#ec0c39","#AF65EF","#ffd700","#C1C1C1","#FFFFFF"],L={colors:{default:"#1a1a1a",current:"#1a1a1a",available:["#1a1a1a","#500000","#004000","#000050","#10253F","#400040"]},patterns:{default:"none",current:"none"}};let k=[];let oe=null;let P=null;let b=[],Oe=!1;let R=[];const K={},q={},M={};let F=1e3;K[1]={x:window.innerWidth/2-100,y:window.innerHeight/2-75};q[1]=nt[0];let u=1,S=1;const st=9,E="stickyNotes_active",lt="stickyNotes_deleted",ne="stickyNotes_boardCount",se="stickyNotes_zIndexes",g=t=>parseInt(String(t).replace("px",""))||0,At=(t,e,o=150)=>{const s=$(`.board[data-board-id="${u}"]`);if(!s)return!1;const n=Array.from(s.querySelectorAll(".sticky-note")),i=20;for(const a of n){const r=g(a.style.left),l=g(a.style.top),d=g(a.style.width)||200,c=t<r+d+i&&t+200>r-i,f=e+o,m=l+30,y=e<m&&f>l-i;if(c&&y)return!0}return!1},Jt=(t,e)=>{const o=Math.random()*10-5;let s=t+o,n=e+70;const i=5,a=window.innerWidth-200,r=window.innerHeight-300,l=20;let d=0;for(;d<l&&At(s,n);)n+=40,d++,d>10&&(s=t+250,n=50,d=0);if(n>r){for(n=50,s=t+250;d<l&&At(s,n);)n+=40,d++;if(s>a)for(s=i+50,n=50,d=0;d<l&&At(s,n);)n+=40,d++}const c=Math.min(Math.max(s,i),a),f=Math.min(Math.max(n,i),window.innerHeight-100);return{x:c,y:f}},Ye=t=>{if(t.startsWith("rgba")){const o=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return o?{r:parseInt(o[1]),g:parseInt(o[2]),b:parseInt(o[3])}:null}t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(o,s,n,i)=>s+s+n+n+i+i);const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null};const tt=(t=!1)=>{t?(window.DebouncedStorage.flush(`${E}_board_${u}`),window.DebouncedStorage.save(`${E}_board_${u}`,j())):window.DebouncedStorage.save(`${E}_board_${u}`,j()),typeof O=="function"&&O()},j=()=>{const t=$(`.board[data-board-id="${u}"]`);if(!t)return[];const e=Array.from(t.querySelectorAll(".sticky-note"));return Array.from(e).map(o=>({content:$within(o,".sticky-content").innerHTML,x:g(o.style.left),y:g(o.style.top),color:o.style.backgroundColor||"#ffeb3b",width:o.style.width||"200px",height:o.style.height||"150px",isBold:$within(o,".sticky-content").classList.contains("bold"),noteId:o.dataset.noteId,zIndex:o.style.zIndex||1}))};const ie=()=>{window.DebouncedStorage.save(ne,S.toString())},ae=()=>{const t={color:L.colors.current,pattern:L.patterns.current};window.DebouncedStorage.saveLow(`boardStyles_board_${u}`,t)},re=()=>{const t=$("#shortcutIcon");if(!t)return;const e=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl";t.innerHTML=e,t.className="shortcut-icon focus-hint"},le=()=>{const t=$(".note-input textarea");if(!t)return;const e=$("#shortcutIcon"),o=()=>{if(!e)return;const s=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl",n=t.value.trim();e.innerHTML=n?`${s}+\u21B5`:s,e.classList.toggle("focus-hint",!n),e.classList.toggle("enter-hint",n)};t.addEventListener("focus",()=>{o(),window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{height:"50px"}),requestAnimationFrame(()=>{window.AnimationUtils.updateStyles(t,{height:"200px"})})):(t.style.height="50px",requestAnimationFrame(()=>t.style.height="200px")),t.addEventListener("input",o)}),t.addEventListener("blur",()=>{re(),window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{height:"200px"}),requestAnimationFrame(()=>{window.AnimationUtils.updateStyles(t,{height:"50px"})})):(t.style.height="200px",requestAnimationFrame(()=>t.style.height="50px")),t.removeEventListener("input",o)}),document.addEventListener("mousedown",s=>{!s.target.closest(".note-input")&&document.activeElement===t&&t.blur()})},Vt=(t,e=null)=>{try{return JSON.parse(t)}catch(o){return console.error("Failed to parse JSON data:",o),e}},Xe=()=>{const t="stickyNotes_storageCleanupPerformed";if(!localStorage.getItem(t))try{const e=[];for(let o=0;o<localStorage.length;o++){const s=localStorage.key(o);s&&(s.startsWith("stickyNotes_deleted")||s.startsWith("stickyNotes_zIndexes")||s.startsWith("boardColor_")||s.startsWith("boardPattern_")||s.startsWith("boardStyles_")||s.startsWith("emojiStickers_")||s.startsWith("daysPatternStartDate_")||s.startsWith("emojiUsageOrder"))&&e.push(s)}e.forEach(o=>{localStorage.removeItem(o)}),localStorage.setItem(t,"true")}catch(e){console.error("Error during localStorage cleanup:",e),localStorage.setItem(t,"true")}},ce=()=>{try{if(typeof pt!="function"){setTimeout(ce,50);return}window.DebouncedStorage.flush(),Xe(),typeof Zt=="function"&&Zt();const t=localStorage.getItem(ne);if(t){const o=parseInt(t);if(!isNaN(o)&&o>0){S=Math.min(o,st);for(let s=2;s<=S;s++)typeof Dt=="function"&&Dt(s)}}typeof yt=="function"&&yt();for(let o=1;o<=S;o++){const s=localStorage.getItem(`${E}_board_${o}`);if(s){const n=Vt(s,[]);Array.isArray(n)&&n.forEach(i=>{if(i&&typeof i=="object"&&(i.text||i.content)){K[o]={x:g(i.x),y:g(i.y)},q[o]=i.color||nt[0];const a=i.text||i.content,r=pt(a,i.color||nt[0],g(i.x),g(i.y),!0,i.width||"200px",i.height||"150px",i.isBold||!1,o);r&&i.noteId&&(r.dataset.noteId=i.noteId,M[i.noteId]?(window.AnimationUtils?window.AnimationUtils.updateStyles(r,{zIndex:M[i.noteId].toString()}):r.style.zIndex=M[i.noteId],M[i.noteId]>F&&(F=M[i.noteId])):i.zIndex&&!isNaN(parseInt(i.zIndex))&&(window.AnimationUtils?window.AnimationUtils.updateStyles(r,{zIndex:i.zIndex.toString()}):r.style.zIndex=i.zIndex,M[i.noteId]=parseInt(i.zIndex),parseInt(i.zIndex)>F&&(F=parseInt(i.zIndex))))}})}typeof rt=="function"&&rt(o)}typeof _=="function"&&_(1);const e=localStorage.getItem(lt);if(e){const o=Vt(e,[]);Array.isArray(o)&&(k=o,typeof G=="function"&&G())}["updateBoardIndicators","updateShortcutHintVisibility"].forEach(o=>{typeof window[o]=="function"&&window[o]()}),re(),le()}catch(t){console.error("Critical error loading saved data:",t)}},Mt=()=>++F,He=t=>{window.AnimationUtils?window.AnimationUtils.updateStyles(t,{zIndex:Mt().toString()}):t.style.zIndex=Mt();const e=t.dataset.noteId;e&&(M[e]=F,de())},de=()=>{try{window.DebouncedStorage.saveLow(se,M)}catch(t){console.error("Error saving note z-indexes:",t)}},Pe=()=>{try{const t=localStorage.getItem(se);t&&(Object.assign(M,JSON.parse(t)),F=Math.max(1e3,...Object.values(M)))}catch(t){console.error("Error loading note z-indexes:",t)}};const Zt=()=>{P=Object.assign(document.createElement("div"),{className:"selection-box"}),Object.assign(P.style,{display:"none"}),document.body.appendChild(P)};function Re(){const t=$(".boards-container"),e=o=>{o.target.closest(".board")&&!o.target.closest(".sticky-note, .note-input, .boards-navigation, .trash-bin, .board-style-button")&&o.preventDefault()};document.addEventListener("mousedown",e),t.addEventListener("mousedown",qe),document.addEventListener("mousemove",ze),document.addEventListener("mouseup",Fe)}function qe(t){if(t.target.closest(".sticky-note, .note-input, .trash-bin, .boards-navigation, .board-style-button, .emoji-sticker"))return;t.preventDefault();const e=$(".note-input textarea");e&&document.activeElement===e&&e.blur(),!t.shiftKey&&bt(),window.isSelecting=!0,window.selectionStartX=t.clientX,window.selectionStartY=t.clientY,document.body.classList.add("selecting"),window.AnimationUtils?window.AnimationUtils.updateStyles(P,{left:`${window.selectionStartX}px`,top:`${window.selectionStartY}px`,width:"0",height:"0",display:"block"}):P.style.cssText=`left:${window.selectionStartX}px; top:${window.selectionStartY}px; width:0; height:0; display:block;`}function ze(t){if(!window.isSelecting)return;t.preventDefault();const e=window.selectionStartX,o=window.selectionStartY,s=t.clientX,n=t.clientY;AnimationUtils.updateStyles(P,{left:`${Math.min(e,s)}px`,top:`${Math.min(o,n)}px`,width:`${Math.abs(s-e)}px`,height:`${Math.abs(n-o)}px`},"high"),We()}const Fe=t=>{window.isSelecting&&(window.isSelecting=!1,document.body.classList.remove("selecting"),window.AnimationUtils?window.AnimationUtils.updateStyles(P,{display:"none"}):P.style.display="none")};function We(){const t=P.getBoundingClientRect(),e=$(`.board[data-board-id="${u}"]`);if(!e)return;const o=(s,n,i)=>{const a=s.getBoundingClientRect(),r=!(a.right<t.left||a.left>t.right||a.bottom<t.top||a.top>t.bottom),l=n.indexOf(s);r?l===-1&&(n.push(s),s.classList.add(i)):!Oe&&l!==-1&&(n.splice(l,1),s.classList.remove(i))};Array.from(e.querySelectorAll(".sticky-note")).forEach(s=>o(s,b,"selected"))}const bt=()=>{b.forEach(t=>t.classList.remove("selected")),b=[]};function Ke(t){window.isMovingSelection=!0,window.selectionMoveStartX=t.clientX,window.selectionMoveStartY=t.clientY,document.body.classList.add("selecting"),R=b.map(e=>({element:e,x:g(e.style.left),y:g(e.style.top),type:"note"})),document.addEventListener("mousemove",ue),document.addEventListener("mouseup",me)}function ue(t){if(!window.isMovingSelection)return;const[e,o]=[t.clientX-window.selectionMoveStartX,t.clientY-window.selectionMoveStartY],[s,n,i]=[5,-5,-5],[a,r]=[window.innerWidth-s,window.innerHeight-s];(d=>d.forEach(c=>{const[f,m]=[Math.min(Math.max(c.x+e,n),a-c.element.offsetWidth/4),Math.min(Math.max(c.y+o,i),r-c.element.offsetHeight/4)];AnimationUtils.updatePosition(c.element,f,m)}))(R),b.length>0&&(ge(t.clientX,t.clientY),b.length>1&&we())}function me(t){if(!window.isMovingSelection)return;if(window.isMovingSelection=!1,document.body.classList.remove("selecting"),document.removeEventListener("mousemove",ue),document.removeEventListener("mouseup",me),St(),!ve().moved){tt();for(let o=b.length-1;o>=0;o--)fe(b[o])&&b.splice(o,1)}be()}let et=[];const Je=100,Gt=50,Ve="#ffd700",Ze=()=>{const[t,e]=[$("#trashModal"),$(".clear-trash-btn")];t&&!t.classList.contains("visible")&&(t.style.display="block",t.classList.add("visible"),requestAnimationFrame(()=>vt())),e&&(e.classList.add("shake-animation"),setTimeout(()=>e.classList.remove("shake-animation"),1e3))},_t=t=>{b.includes(t)&&b.length>1?(b.forEach((e,o)=>setTimeout(()=>It(e),o*100)),bt()):It(t)},It=t=>{if(k.length>=Je){!et.includes(t)&&et.push(t),Ze();return}t._eventCleanup&&t._eventCleanup();const e=$within(t,".sticky-content"),o={text:e.innerHTML,color:t.style.backgroundColor,x:t.style.left,y:t.style.top,width:t.style.width,height:t.style.height,timestamp:new Date().toLocaleString(),isBold:e.classList.contains("bold")};Ge(t),k.unshift(o),window.DebouncedStorage.saveLow(lt,k),G(),Qe(t)},Ge=t=>{if(!window.noteColumns)return;const e=t.closest(".board");if(!e||!e.matches(".board-pattern-weekdays, .board-pattern-days"))return;const[o,s]=[e.getBoundingClientRect(),t.getBoundingClientRect()],n=Math.min(5,Math.max(0,Math.floor((s.left+s.width/2-o.left)/(o.width/6))));window.noteColumns[n]&&(window.noteColumns[n]=window.noteColumns[n].filter(i=>Math.abs(i.x-g(t.style.left))>1||Math.abs(i.y-g(t.style.top))>1))},Qe=t=>{const e=$(".trash-bin"),o=e.getBoundingClientRect(),s=t.getBoundingClientRect(),n=o.left-s.left+o.width/2-s.width/2,i=o.top-s.top;window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{"--throwX":`${n}px`,"--throwY":`${i}px`,animation:"paperCrumble 0.6s ease-in forwards"},"high"),window.AnimationUtils.updateStyles(e,{animation:"binShake 0.6s ease-in-out"},"high")):(t.style.setProperty("--throwX",`${n}px`),t.style.setProperty("--throwY",`${i}px`),t.style.animation="paperCrumble 0.6s ease-in forwards",e.style.animation="binShake 0.6s ease-in-out"),setTimeout(()=>{t.remove(),window.AnimationUtils?window.AnimationUtils.updateStyles(e,{animation:""},"normal"):e.style.animation="",tt(),O()},600)},fe=t=>{const[e,o]=[$(".trash-bin").getBoundingClientRect(),t.getBoundingClientRect()];return o.right>e.left&&o.left<e.right&&o.bottom>e.top&&o.top<e.bottom?(_t(t),!0):!1},it=()=>{const t=document.getElementById("trashModal");t.classList.toggle("visible")?(t.style.display="block",requestAnimationFrame(()=>vt())):setTimeout(()=>{window.AnimationUtils?window.AnimationUtils.updateStyles(t,{display:"none"},"normal"):t.style.display="none"},300)},vt=()=>{const t=$(".deleted-notes-container");window.AnimationUtils?window.AnimationUtils.updateStyles(t,{minHeight:"200px"},"normal"):t.style.minHeight="200px",t.innerHTML=k.length?k.map((e,o)=>`
