(()=>{const nt=["#f0e68c","#98ff98","#ff7eb9","#7afcff","#FE8801","#ec0c39","#AF65EF","#ffd700","#C1C1C1","#FFFFFF"],N={colors:{default:"#1a1a1a",current:"#1a1a1a",available:["#1a1a1a","#500000","#004000","#000050","#10253F","#400040"]},patterns:{default:"none",current:"none"}};let _=[];let Z=null,Kt=null,ut=!1,G=null,mt=0,ft=0,L=[],st=!1,Jt=0,Vt=0,U=[];const K={},J={},O={};let R=1e3;K[1]={x:window.innerWidth/2-100,y:window.innerHeight/2-75};J[1]=nt[0];let u=1,T=1;const at=9,Q="stickyNotes_active",Zt="stickyNotes_deleted",Gt="stickyNotes_boardCount",Qt="stickyNotes_zIndexes",v=t=>parseInt(String(t).replace("px",""))||0,Xt=(t,e)=>{const o=Math.random()*10-5;let n=t+o,a=e+70;const s=5,r=window.innerWidth-200,i=window.innerHeight-300;a>i&&(a=50,n=t+250,n>r&&(n=s+50,a=50));const c=Math.min(Math.max(n,s),r),f=Math.min(Math.max(a,s),window.innerHeight-100);return{x:c,y:f}},Ce=t=>{if(t.startsWith("rgba")){const o=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return o?{r:parseInt(o[1]),g:parseInt(o[2]),b:parseInt(o[3])}:null}t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(o,n,a,s)=>n+n+a+a+s+s);const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null},$t=(t,e)=>{try{localStorage.setItem(t,JSON.stringify(e))}catch(o){console.error(`Failed to save to localStorage (${t}):`,o)}},P=()=>{const t=document.querySelector(`.board[data-board-id="${u}"]`);if(!t)return;const e=Array.from(t.querySelectorAll(".sticky-note")).map(o=>({text:o.querySelector(".sticky-content").innerHTML,color:o.style.backgroundColor,x:o.style.left,y:o.style.top,width:o.style.width||"200px",height:o.style.height||"150px",isBold:o.querySelector(".sticky-content").classList.contains("bold"),noteId:o.dataset.noteId,zIndex:o.style.zIndex||1}));$t(`${Q}_board_${u}`,e),typeof Y=="function"&&Y()},bt=()=>$t(Zt,_),te=()=>localStorage.setItem(Gt,T.toString()),ee=()=>$t(`boardStyles_board_${u}`,{color:N.colors.current,pattern:N.patterns.current}),oe=()=>{const t=document.getElementById("shortcutIcon");if(!t)return;const e=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl";t.innerHTML=e,t.className="shortcut-icon focus-hint"},ne=()=>{const t=document.querySelector(".note-input textarea");if(!t)return;const e=document.getElementById("shortcutIcon"),o=()=>{if(!e)return;const n=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl",a=t.value.trim();e.innerHTML=a?`${n}+\u21B5`:n,e.classList.toggle("focus-hint",!a),e.classList.toggle("enter-hint",a)};t.addEventListener("focus",()=>{o(),t.style.height="50px",requestAnimationFrame(()=>t.style.height="200px"),t.addEventListener("input",o)}),t.addEventListener("blur",()=>{oe(),t.style.height="200px",requestAnimationFrame(()=>t.style.height="50px"),t.removeEventListener("input",o)}),document.addEventListener("mousedown",n=>{!n.target.closest(".note-input")&&document.activeElement===t&&t.blur()})},Ht=(t,e=null)=>{try{return JSON.parse(t)}catch(o){return console.error("Failed to parse JSON data:",o),e}},Te=()=>{const t="stickyNotes_storageCleanupPerformed";if(!localStorage.getItem(t))try{console.log("Performing one-time localStorage cleanup...");const e=[];for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);n&&(n.startsWith("stickyNotes_")||n.startsWith("boardColor_")||n.startsWith("boardPattern_")||n.startsWith("boardStyles_")||n.startsWith("emojiStickers_")||n.startsWith("daysPatternStartDate_")||n.startsWith("emojiUsageOrder"))&&e.push(n)}e.forEach(o=>{localStorage.removeItem(o)}),console.log(`Cleaned up ${e.length} localStorage items`),localStorage.setItem(t,"true")}catch(e){console.error("Error during localStorage cleanup:",e),localStorage.setItem(t,"true")}},qe=()=>{try{Te(),typeof zt=="function"&&zt();const t=localStorage.getItem(Gt);if(t){const o=parseInt(t);if(!isNaN(o)&&o>0){T=Math.min(o,at);for(let n=2;n<=T;n++)typeof Mt=="function"&&Mt(n)}}typeof ht=="function"&&ht();for(let o=1;o<=T;o++){const n=localStorage.getItem(`${Q}_board_${o}`);if(n){const a=Ht(n,[]);Array.isArray(a)&&a.forEach(s=>{if(s&&typeof s=="object"&&s.text&&(K[o]={x:v(s.x),y:v(s.y)},J[o]=s.color||nt[0],typeof yt=="function")){const r=yt(s.text,s.color||nt[0],v(s.x),v(s.y),!0,s.width||"200px",s.height||"150px",s.isBold||!1,o);r&&s.noteId&&(r.dataset.noteId=s.noteId,O[s.noteId]?(r.style.zIndex=O[s.noteId],O[s.noteId]>R&&(R=O[s.noteId])):s.zIndex&&!isNaN(parseInt(s.zIndex))&&(r.style.zIndex=s.zIndex,O[s.noteId]=parseInt(s.zIndex),parseInt(s.zIndex)>R&&(R=parseInt(s.zIndex))))}})}typeof lt=="function"&&lt(o)}typeof z=="function"&&z(1);const e=localStorage.getItem(Zt);if(e){const o=Ht(e,[]);Array.isArray(o)&&(_=o,typeof tt=="function"&&tt())}["updateBoardIndicators","updateShortcutHintVisibility"].forEach(o=>{typeof window[o]=="function"&&window[o]()}),oe(),ne()}catch(t){console.error("Critical error loading saved data:",t)}},Me=t=>{t.style.zIndex=++R;const e=t.dataset.noteId;e&&(O[e]=R,se())},se=()=>{try{localStorage.setItem(Qt,JSON.stringify(O))}catch(t){console.error("Error saving note z-indexes:",t)}},$e=()=>{try{const t=localStorage.getItem(Qt);t&&(Object.assign(O,JSON.parse(t)),R=Math.max(1e3,...Object.values(O)))}catch(t){console.error("Error loading note z-indexes:",t)}};const zt=()=>{G=Object.assign(document.createElement("div"),{className:"selection-box"}),Object.assign(G.style,{display:"none"}),document.body.appendChild(G)};function Ne(){const t=document.querySelector(".boards-container");document.addEventListener("mousedown",e=>{e.target.closest(".board")&&!e.target.closest(".sticky-note, .note-input, .boards-navigation, .trash-bin, .board-style-button")&&e.preventDefault()}),[["mousedown",Be],["mousemove",Ie],["mouseup",Ae]].forEach(([e,o])=>(e==="mousedown"?t:document).addEventListener(e,o))}function Be(t){if(t.target.closest(".sticky-note, .note-input, .trash-bin, .boards-navigation, .board-style-button, .emoji-sticker"))return;t.preventDefault();const e=document.querySelector(".note-input textarea");e&&document.activeElement===e&&e.blur(),!t.shiftKey&&vt(),[ut,mt,ft]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),G.style.cssText=`left:${mt}px; top:${ft}px; width:0; height:0; display:block;`}function Ie(t){if(!ut)return;t.preventDefault();const[e,o]=[Math.abs(t.clientX-mt),Math.abs(t.clientY-ft)],[n,a]=[Math.min(t.clientX,mt),Math.min(t.clientY,ft)];G.style.cssText=`left:${n}px; top:${a}px; width:${e}px; height:${o}px; display:block;`,je()}const Ae=()=>{ut&&(ut=!1,document.body.classList.remove("selecting"),G.style.display="none")};function je(){const t=G.getBoundingClientRect(),e=document.querySelector(`.board[data-board-id="${u}"]`);if(!e)return;const o=(n,a,s)=>{const r=n.getBoundingClientRect(),i=!(r.right<t.left||r.left>t.right||r.bottom<t.top||r.top>t.bottom),c=a.indexOf(n);i?c===-1&&(a.push(n),n.classList.add(s)):!st&&c!==-1&&(a.splice(c,1),n.classList.remove(s))};e.querySelectorAll(".sticky-note").forEach(n=>o(n,L,"selected"))}const vt=()=>{L.forEach(t=>t.classList.remove("selected")),L=[]};function De(t){[st,Jt,Vt]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),U=L.map(e=>({element:e,x:v(e.style.left),y:v(e.style.top),type:"note"})),["mousemove","mouseup"].forEach(e=>document.addEventListener(e,e==="mousemove"?ae:re))}function ae(t){if(!st)return;const[e,o]=[t.clientX-Jt,t.clientY-Vt],[n,a,s]=[5,-5,-5],[r,i]=[window.innerWidth-n,window.innerHeight-n];(f=>f.forEach(d=>{const[b,y]=[Math.min(Math.max(d.x+e,a),r-d.element.offsetWidth/4),Math.min(Math.max(d.y+o,s),i-d.element.offsetHeight/4)];Object.assign(d.element.style,{left:`${b}px`,top:`${y}px`})}))(U),L.length>0&&(ue(t.clientX,t.clientY),L.length>1&&jt())}function re(){if(!st)return;if(st=!1,document.body.classList.remove("selecting"),["mousemove","mouseup"].forEach(e=>document.removeEventListener(e,e==="mousemove"?ae:re)),ct(),!fe().moved){P();for(let e=L.length-1;e>=0;e--)ie(L[e])&&L.splice(e,1)}Dt()}let ot=[];const Oe=100,Wt=50,Re="#ffd700",_e=()=>{const[t,e]=[document.getElementById("trashModal"),document.querySelector(".clear-trash-btn")];t&&!t.classList.contains("visible")&&(t.style.display="block",t.classList.add("visible"),requestAnimationFrame(()=>St())),e&&(e.classList.add("shake-animation"),setTimeout(()=>e.classList.remove("shake-animation"),1e3))},Nt=t=>{L.includes(t)&&L.length>1?(L.forEach((e,o)=>setTimeout(()=>Tt(e),o*100)),vt()):Tt(t)},Tt=t=>{if(_.length>=Oe){!ot.includes(t)&&ot.push(t),_e();return}const e=t.querySelector(".sticky-content"),o={text:e.innerHTML,color:t.style.backgroundColor,x:t.style.left,y:t.style.top,width:t.style.width,height:t.style.height,timestamp:new Date().toLocaleString(),isBold:e.classList.contains("bold")};Pe(t),_.unshift(o),bt(),tt(),Ye(t)},Pe=t=>{if(!window.noteColumns)return;const e=t.closest(".board");if(!e||!e.matches(".board-pattern-weekdays, .board-pattern-days"))return;const[o,n]=[e.getBoundingClientRect(),t.getBoundingClientRect()],a=Math.min(5,Math.max(0,Math.floor((n.left+n.width/2-o.left)/(o.width/6))));window.noteColumns[a]&&(window.noteColumns[a]=window.noteColumns[a].filter(s=>Math.abs(s.x-v(t.style.left))>1||Math.abs(s.y-v(t.style.top))>1))},Ye=t=>{const e=document.querySelector(".trash-bin"),o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),a=o.left-n.left+o.width/2-n.width/2,s=o.top-n.top;t.style.setProperty("--throwX",`${a}px`),t.style.setProperty("--throwY",`${s}px`),t.style.animation="paperCrumble 0.6s ease-in forwards",e.style.animation="binShake 0.6s ease-in-out",setTimeout(()=>{t.remove(),e.style.animation="",P(),Y()},600)},ie=t=>{const[e,o]=[document.querySelector(".trash-bin").getBoundingClientRect(),t.getBoundingClientRect()];return o.right>e.left&&o.left<e.right&&o.bottom>e.top&&o.top<e.bottom?(Nt(t),!0):!1},rt=()=>{const t=document.getElementById("trashModal");t.classList.toggle("visible")?(t.style.display="block",requestAnimationFrame(()=>St())):setTimeout(()=>t.style.display="none",300)},St=()=>{const t=document.querySelector(".deleted-notes-container");t.style.minHeight="200px",t.innerHTML=_.length?_.map((e,o)=>`
            ...
            </div>`).join(""):'<div class="empty-state">(Empty)</div>'},Xe=t=>{const e=document.querySelectorAll(".deleted-note")[t];e==null||e.classList.add("shrinking"),setTimeout(()=>{const[o]=_.splice(t,1);yt(o.text,o.color,v(o.x),v(o.y),!0,o.width,o.height,o.isBold),bt(),tt(),St(),P(),Y()},300)},ce=()=>{if(_.length===0){rt();return}const t=[...document.querySelectorAll(".deleted-note")].slice(0,6);t.forEach((e,o)=>{e.classList.add("note-deleting"),e.style.animationDelay=`${o*Wt}ms`}),setTimeout(()=>{_=[],bt(),tt(),St(),setTimeout(()=>{if(rt(),ot.length){const e=[...ot];ot=[],setTimeout(()=>{e.forEach(o=>{o!=null&&o.parentNode&&Tt(o)})},300)}},200)},(t.length?(t.length-1)*Wt+300:0)+100)},tt=()=>{document.querySelector(".trash-count").textContent=_.length};document.addEventListener("click",t=>{const e=document.getElementById("trashModal");e!=null&&e.classList.contains("visible")&&t.target===e&&rt()});let Bt=new Set;const It=()=>`note_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,He=()=>Math.random()*40-20,ze=(t=Et())=>t.getDay()===0?0:t.getDay()-1;function Lt(t){const e=document.getElementById("noteLimitMessage"),o=e==null?void 0:e.querySelector(".transfer-text");o&&(o.textContent=t),e&&(e.classList.add("visible"),setTimeout(()=>e.classList.remove("visible"),3e3))}function At(){const t=document.querySelector(".note-input textarea"),e=t.value.trim();if(!e)return;const o=document.querySelector(`.board[data-board-id="${u}"]`),n=Array.from(o.querySelectorAll(".sticky-note")),[a,s,r]=[o.classList.contains("board-pattern-weekdays"),o.classList.contains("board-pattern-days"),n.filter(p=>!p.dataset.transferred).length===0];if(!a&&!s&&n.length>=30){Lt("Maximum notes space reached.");return}const i=n.filter(p=>!p.dataset.transferred),c=i[i.length-1];let{x:f,y:d}=K[u]||{x:0,y:0},b=J[u]||getRandomColor(),y,h;const w=(p,E,C=null)=>{const x=o.offsetWidth/E,$=p*x+10,W=(p+1)*x-210,X=Math.max($,Math.min(W,$+He())),A=Array.from(o.querySelectorAll(".sticky-note")).filter(m=>m.style.display!=="none"&&m!==C),[j,F]=[p*x,(p+1)*x],l=A.filter(m=>{const[g,S]=[v(m.style.left),v(m.style.left)+200],[I,V]=[Math.max(g,j),Math.min(S,F)];return Math.max(0,V-I)/200>.5});return{positionX:X,columnNotes:l}},M=(p,E)=>{const C=window.innerHeight-300;for(let x=0;x<E;x++){const $=(p+x)%E,{positionX:W,columnNotes:X}=w($,E);let A=60,j=null;X.forEach(l=>{const m=v(l.style.top);m>=A&&(A=m,j=l)});const F=j?A+70:60;if(F<=C)return y=W,h=F,j&&(b=j.style.backgroundColor),!0}return Lt("Maximum notes space reached."),!1},k=p=>{let E;const C=p?6:5;if(c){const x=v(c.style.left),$=o.offsetWidth/C;E=Math.floor(x/$),E=Math.max(0,Math.min(E,C-1))}else E=p?ze():Rt(u)||0;return M(E,C)};if(r)if(a||s){if(k(a)===!1)return}else{const p=Math.max(150,window.innerWidth/4);({x:y,y:h}=Xt(p-250,50-70))}else if(a||s){if(k(a)===!1)return}else if(c&&([f,d,b]=[v(c.style.left),v(c.style.top),c.style.backgroundColor]),{x:y,y:h}=Xt(f,d),h<=50){const p=n.filter(E=>Math.abs(v(E.style.left)-y)<150);if(p.length>0){const E=p.map(A=>v(A.style.top)),[C,x]=[Math.max(...E),Math.min(...E)],$=window.innerHeight-300,[W,X]=[C+200,x-200];if(W<=$)h=W;else if(X>=50)h=X;else{const A=(F,l)=>{const m=window.innerWidth-200;for(let g=F;l>0?g<=m:g>=55;g+=l*250){const S=n.filter(wt=>Math.abs(v(wt.style.left)-g)<150);if(S.length===0)return{x:g,y:50};const I=S.map(wt=>v(wt.style.top)),[V,xt]=[Math.max(...I),Math.min(...I)],[et,Yt]=[V+200,xt-200];if(et<=$)return{x:g,y:et};if(Yt>=50)return{x:g,y:Yt}}return null},j=A(y+250,1)||A(y-250,-1);if(j)[y,h]=[j.x,j.y];else{Lt("Maximum notes space reached.");return}}}}yt(e.replace(/\n/g,"<br>"),b,y,h,!1,"200px","150px",!1,u),[K[u],J[u],t.value]=[{x:y,y:h},b,""],o.querySelectorAll('.sticky-note[data-transferred="true"]').forEach(p=>{delete p.dataset.transferred}),P(),Y()}function yt(t,e,o,n,a=!1,s="200px",r="150px",i=!1,c=u,f=!1){const[d,b]=[document.createElement("div"),It()];Object.assign(d,{className:"sticky-note",innerHTML:`<div class="sticky-content ${i?"bold":""}" contenteditable="true">${t}</div>
