(()=>{var He=Object.defineProperty;var Zt=Object.getOwnPropertySymbols;var Pe=Object.prototype.hasOwnProperty,qe=Object.prototype.propertyIsEnumerable;var P=Math.pow,Jt=(t,e,n)=>e in t?He(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Dt=(t,e)=>{for(var n in e||(e={}))Pe.call(e,n)&&Jt(t,n,e[n]);if(Zt)for(var n of Zt(e))qe.call(e,n)&&Jt(t,n,e[n]);return t};const F=new Map,Qt=()=>{Object.entries({trashBin:".trash-bin",statusBar:".status-bar",noteInput:".note-input",selectionBox:".selection-box"}).forEach(([e,n])=>{const s=document.querySelector(n);s&&F.set(e,s)})};window.$=t=>{if(F.has(t)){const e=F.get(t);return e.isConnected?e:(F.delete(t),document.querySelector(t))}return document.querySelector(t)};window.$$=(t,e=!1)=>{if(e&&F.has(t)){const n=F.get(t);return n.every(s=>s.isConnected)?n:(F.delete(t),Array.from(document.querySelectorAll(t)))}return Array.from(document.querySelectorAll(t))};window.$within=(t,e)=>t?t.querySelector(e):null;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Qt):Qt();const ht=new Map;let st=null;const le=()=>{ht.forEach(({element:t,styles:e})=>{t.isConnected&&Object.entries(e).forEach(([n,s])=>{n.startsWith("--")?t.style.setProperty(n,s):t.style[n]=s})}),ht.clear(),st=null},Re=()=>{st||(st=requestAnimationFrame(le))};window.AnimationUtils={updateStyles(t,e,n="normal"){var o;if(!t||!e)return;const s=t._batchId||(t._batchId=Math.random().toString(36));ht.set(s,{element:t,styles:Dt(Dt({},(o=ht.get(s))==null?void 0:o.styles),e)}),Re()},updatePosition(t,e,n){this.updateStyles(t,{left:`${e}px`,top:`${n}px`})},updateSize(t,e,n){this.updateStyles(t,{width:`${e}px`,height:`${n}px`})},flush(){st&&(cancelAnimationFrame(st),le())}};const nt=new Map,gt=new Map,Tt=t=>{if(nt.has(t))try{const e=nt.get(t);localStorage.setItem(t,typeof e=="string"?e:JSON.stringify(e)),nt.delete(t),gt.delete(t)}catch(e){}};window.DebouncedStorage={save(t,e,n="normal"){gt.has(t)&&clearTimeout(gt.get(t)),nt.set(t,e);const s=n==="high"?50:n==="low"?1e3:300;gt.set(t,setTimeout(()=>Tt(t),s))},saveHigh(t,e){this.save(t,e,"high")},saveLow(t,e){this.save(t,e,"low")},flush(t){Tt(t)},flushAll(){nt.forEach((t,e)=>Tt(e))}};window.addEventListener("beforeunload",()=>window.DebouncedStorage.flushAll());const at=["#f0e68c","#98ff98","#ff7eb9","#7afcff","#FE8801","#ec0c39","#AF65EF","#ffd700","#C1C1C1","#FFFFFF"],A={colors:{default:"#1a1a1a",current:"#1a1a1a",available:["#1a1a1a","#500000","#004000","#000050","#10253F","#400040"]},patterns:{default:"none",current:"none"}};let D=[];let ce=null;let q=null;let b=[],ze=!1;let E=[];const W={},R={},N={};let j=1e3;W[1]={x:window.innerWidth/2-100,y:window.innerHeight/2-75};R[1]=at[0];let u=1,x=1;const it=9,L="stickyNotes_active",dt="stickyNotes_deleted",de="stickyNotes_boardCount",ue="stickyNotes_zIndexes",g=t=>parseInt(String(t).replace("px",""))||0,Nt=(t,e,n=150)=>{const s=$(`.board[data-board-id="${u}"]`);if(!s)return!1;const o=Array.from(s.querySelectorAll(".sticky-note")),a=20;for(const i of o){const r=g(i.style.left),l=g(i.style.top),d=g(i.style.width)||200,c=t<r+d+a&&t+200>r-a,m=e+n,f=l+30,h=e<f&&m>l-a;if(c&&h)return!0}return!1},te=(t,e)=>{const n=Math.random()*10-5;let s=t+n,o=e+70;const a=5,i=window.innerWidth-200,r=window.innerHeight-300,l=20;let d=0;for(;d<l&&Nt(s,o);)o+=40,d++,d>10&&(s=t+250,o=50,d=0);if(o>r){for(o=50,s=t+250;d<l&&Nt(s,o);)o+=40,d++;if(s>i)for(s=a+50,o=50,d=0;d<l&&Nt(s,o);)o+=40,d++}const c=Math.min(Math.max(s,a),i),m=Math.min(Math.max(o,a),window.innerHeight-100);return{x:c,y:m}},Fe=t=>{if(t.startsWith("rgba")){const n=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return n?{r:parseInt(n[1]),g:parseInt(n[2]),b:parseInt(n[3])}:null}t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(n,s,o,a)=>s+s+o+o+a+a);const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null};const J=(t=!1)=>{t?(window.DebouncedStorage.flush(`${L}_board_${u}`),window.DebouncedStorage.save(`${L}_board_${u}`,X())):window.DebouncedStorage.save(`${L}_board_${u}`,X()),typeof O=="function"&&O()},X=()=>{const t=$(`.board[data-board-id="${u}"]`);if(!t)return[];const e=Array.from(t.querySelectorAll(".sticky-note"));return Array.from(e).map(n=>({content:$within(n,".sticky-content").innerHTML,x:g(n.style.left),y:g(n.style.top),color:n.style.backgroundColor||"#ffeb3b",width:n.style.width||"200px",height:n.style.height||"150px",isBold:$within(n,".sticky-content").classList.contains("bold"),noteId:n.dataset.noteId,zIndex:n.style.zIndex||1}))};const me=()=>{window.DebouncedStorage.save(de,x.toString())},fe=()=>{const t={color:A.colors.current,pattern:A.patterns.current};window.DebouncedStorage.saveLow(`boardStyles_board_${u}`,t)},Ot=()=>{const t=$("#shortcutIcon");if(!t)return;const e=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl";t.innerHTML=e,t.className="shortcut-icon focus-hint"},pe=()=>{const t=$(".note-input textarea");if(!t)return;const e=$("#shortcutIcon"),n=()=>{if(!e)return;const s=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl",o=t.value.trim();e.innerHTML=o?`${s}+\u21B5`:s,e.classList.toggle("focus-hint",!o),e.classList.toggle("enter-hint",o)};t.addEventListener("focus",()=>{n(),window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{height:"50px"}),requestAnimationFrame(()=>{window.AnimationUtils.updateStyles(t,{height:"200px"})})):(window.AnimationUtils.updateStyles(t,{height:"50px"}),requestAnimationFrame(()=>window.AnimationUtils.updateStyles(t,{height:"200px"}))),t.addEventListener("input",n)}),t.addEventListener("blur",()=>{Ot(),window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{height:"200px"}),requestAnimationFrame(()=>{window.AnimationUtils.updateStyles(t,{height:"50px"})})):(window.AnimationUtils.updateStyles(t,{height:"200px"}),requestAnimationFrame(()=>window.AnimationUtils.updateStyles(t,{height:"50px"}))),t.removeEventListener("input",n)}),document.addEventListener("mousedown",s=>{!s.target.closest(".note-input")&&document.activeElement===t&&t.blur()})},ee=(t,e=null)=>{try{return JSON.parse(t)}catch(n){return e}},We=()=>{const t="stickyNotes_storageCleanupPerformed";if(!localStorage.getItem(t))try{const e=[];for(let n=0;n<localStorage.length;n++){const s=localStorage.key(n);s&&(s.startsWith("stickyNotes_deleted")||s.startsWith("stickyNotes_zIndexes")||s.startsWith("boardColor_")||s.startsWith("boardPattern_")||s.startsWith("boardStyles_")||s.startsWith("emojiStickers_")||s.startsWith("daysPatternStartDate_")||s.startsWith("emojiUsageOrder"))&&e.push(s)}e.forEach(n=>{localStorage.removeItem(n)}),window.DebouncedStorage.saveHigh(t,"true")}catch(e){window.DebouncedStorage.saveHigh(t,"true")}},ge=()=>{try{if(typeof wt!="function"){setTimeout(ge,50);return}window.DebouncedStorage.flush(),We(),typeof ne=="function"&&ne();const t=localStorage.getItem(de);if(t){const n=parseInt(t);if(!isNaN(n)&&n>0){x=Math.min(n,it);for(let s=2;s<=x;s++)typeof Yt=="function"&&Yt(s)}}typeof St=="function"&&St();for(let n=1;n<=x;n++){const s=localStorage.getItem(`${L}_board_${n}`);if(s){const o=ee(s,[]);Array.isArray(o)&&o.forEach(a=>{if(a&&typeof a=="object"&&(a.text||a.content)){W[n]={x:g(a.x),y:g(a.y)},R[n]=a.color||at[0];const i=a.text||a.content,r=wt(i,a.color||at[0],g(a.x),g(a.y),!0,a.width||"200px",a.height||"150px",a.isBold||!1,n);r&&a.noteId&&(r.dataset.noteId=a.noteId,N[a.noteId]?(window.AnimationUtils?window.AnimationUtils.updateStyles(r,{zIndex:N[a.noteId].toString()}):r.style.zIndex=N[a.noteId],N[a.noteId]>j&&(j=N[a.noteId])):a.zIndex&&!isNaN(parseInt(a.zIndex))&&(window.AnimationUtils?window.AnimationUtils.updateStyles(r,{zIndex:a.zIndex.toString()}):r.style.zIndex=a.zIndex,N[a.noteId]=parseInt(a.zIndex),parseInt(a.zIndex)>j&&(j=parseInt(a.zIndex))))}})}typeof ct=="function"&&ct(n)}typeof Y=="function"&&Y(1);const e=localStorage.getItem(dt);if(e){const n=ee(e,[]);Array.isArray(n)&&(D=n,typeof Q=="function"&&Q())}["updateBoardIndicators","updateShortcutHintVisibility"].forEach(n=>{typeof window[n]=="function"&&window[n]()}),Ot(),pe()}catch(t){}},It=()=>++j,Ke=t=>{window.AnimationUtils?window.AnimationUtils.updateStyles(t,{zIndex:It().toString()}):t.style.zIndex=It();const e=t.dataset.noteId;e&&(N[e]=j,Ht())},Ht=()=>{try{window.DebouncedStorage.saveLow(ue,N)}catch(t){}},Ge=()=>{try{const t=localStorage.getItem(ue);t&&(Object.assign(N,JSON.parse(t)),j=Math.max(1e3,...Object.values(N)))}catch(t){}};const ne=()=>{q=Object.assign(document.createElement("div"),{className:"selection-box"}),Object.assign(q.style,{display:"none"}),document.body.appendChild(q)};function Ve(){const t=$(".boards-container"),e=n=>{n.target.closest(".board")&&!n.target.closest(".sticky-note, .note-input, .boards-navigation, .trash-bin, .board-style-button")&&n.preventDefault()};document.addEventListener("mousedown",e),t.addEventListener("mousedown",Ze),document.addEventListener("mousemove",Je),document.addEventListener("mouseup",Qe)}function Ze(t){if(t.target.closest(".sticky-note, .note-input, .trash-bin, .boards-navigation, .board-style-button, .emoji-sticker"))return;t.preventDefault();const e=$(".note-input textarea");e&&document.activeElement===e&&e.blur(),!t.shiftKey&&xt(),window.isSelecting=!0,window.selectionStartX=t.clientX,window.selectionStartY=t.clientY,document.body.classList.add("selecting"),window.AnimationUtils?window.AnimationUtils.updateStyles(q,{left:`${window.selectionStartX}px`,top:`${window.selectionStartY}px`,width:"0",height:"0",display:"block"}):q.style.cssText=`left:${window.selectionStartX}px; top:${window.selectionStartY}px; width:0; height:0; display:block;`}function Je(t){if(!window.isSelecting)return;t.preventDefault();const e=window.selectionStartX,n=window.selectionStartY,s=t.clientX,o=t.clientY;AnimationUtils.updateStyles(q,{left:`${Math.min(e,s)}px`,top:`${Math.min(n,o)}px`,width:`${Math.abs(s-e)}px`,height:`${Math.abs(o-n)}px`},"high"),tn()}const Qe=t=>{window.isSelecting&&(window.isSelecting=!1,document.body.classList.remove("selecting"),window.AnimationUtils?window.AnimationUtils.updateStyles(q,{display:"none"}):q.style.display="none")};function tn(){const t=q.getBoundingClientRect(),e=$(`.board[data-board-id="${u}"]`);if(!e)return;const n=(s,o,a)=>{const i=s.getBoundingClientRect(),r=!(i.right<t.left||i.left>t.right||i.bottom<t.top||i.top>t.bottom),l=o.indexOf(s);r?l===-1&&(o.push(s),s.classList.add(a)):!ze&&l!==-1&&(o.splice(l,1),s.classList.remove(a))};Array.from(e.querySelectorAll(".sticky-note")).forEach(s=>n(s,b,"selected"))}const xt=()=>{b.forEach(t=>t.classList.remove("selected")),b=[]};function en(t){window.isMovingSelection=!0,window.selectionMoveStartX=t.clientX,window.selectionMoveStartY=t.clientY,document.body.classList.add("selecting"),E=b.map(e=>{const n=g(e.style.left),s=g(e.style.top);return e.dataset.preDragX=n.toString(),e.dataset.preDragY=s.toString(),{element:e,x:n,y:s,type:"note"}}),document.addEventListener("mousemove",he),document.addEventListener("mouseup",ye)}function he(t){if(!window.isMovingSelection)return;const[e,n]=[t.clientX-window.selectionMoveStartX,t.clientY-window.selectionMoveStartY],[s,o,a]=[5,-5,-5],[i,r]=[window.innerWidth-s,window.innerHeight-s];(d=>d.forEach(c=>{const[m,f]=[Math.min(Math.max(c.x+e,o),i-c.element.offsetWidth/4),Math.min(Math.max(c.y+n,a),r-c.element.offsetHeight/4)];AnimationUtils.updatePosition(c.element,m,f)}))(E),b.length>0&&($e(t.clientX,t.clientY),b.length>1&&ke())}function ye(t){if(!window.isMovingSelection)return;if(window.isMovingSelection=!1,document.body.classList.remove("selecting"),document.removeEventListener("mousemove",he),document.removeEventListener("mouseup",ye),ut(),!Ce().moved){J();for(let n=b.length-1;n>=0;n--)we(b[n])&&b.splice(n,1)}Ae()}let ot=[];const nn=100,oe=50,on="#ffd700",sn=()=>{const[t,e]=[$("#trashModal"),$(".clear-trash-btn")];t&&!t.classList.contains("visible")&&(t.style.display="block",t.classList.add("visible"),requestAnimationFrame(()=>Et())),e&&(e.classList.add("shake-animation"),setTimeout(()=>e.classList.remove("shake-animation"),1e3))},Pt=t=>{b.includes(t)&&b.length>1?(b.forEach((e,n)=>setTimeout(()=>_t(e),n*100)),xt()):_t(t)},_t=t=>{if(D.length>=nn){!ot.includes(t)&&ot.push(t),sn();return}t._eventCleanup&&t._eventCleanup();const e=$within(t,".sticky-content"),n={text:e.innerHTML,color:t.style.backgroundColor,x:t.style.left,y:t.style.top,width:t.style.width,height:t.style.height,timestamp:new Date().toLocaleString(),isBold:e.classList.contains("bold")};an(t),D.unshift(n),window.DebouncedStorage.saveLow(dt,D),Q(),rn(t)},an=t=>{if(!window.noteColumns)return;const e=t.closest(".board");if(!e||!e.matches(".board-pattern-weekdays, .board-pattern-days"))return;const[n,s]=[e.getBoundingClientRect(),t.getBoundingClientRect()],o=Math.min(5,Math.max(0,Math.floor((s.left+s.width/2-n.left)/(n.width/6))));window.noteColumns[o]&&(window.noteColumns[o]=window.noteColumns[o].filter(a=>Math.abs(a.x-g(t.style.left))>1||Math.abs(a.y-g(t.style.top))>1))},rn=t=>{const e=$(".trash-bin"),n=e.getBoundingClientRect(),s=t.getBoundingClientRect(),o=n.left-s.left+n.width/2-s.width/2,a=n.top-s.top;window.AnimationUtils?(window.AnimationUtils.updateStyles(t,{"--throwX":`${o}px`,"--throwY":`${a}px`,animation:"paperCrumble 0.6s ease-in forwards"},"high"),window.AnimationUtils.updateStyles(e,{animation:"binShake 0.6s ease-in-out"},"high")):(t.style.setProperty("--throwX",`${o}px`),t.style.setProperty("--throwY",`${a}px`),t.style.animation="paperCrumble 0.6s ease-in forwards",e.style.animation="binShake 0.6s ease-in-out"),setTimeout(()=>{t.remove(),window.AnimationUtils?window.AnimationUtils.updateStyles(e,{animation:""},"normal"):e.style.animation="",J(),O()},600)},we=t=>{const[e,n]=[$(".trash-bin").getBoundingClientRect(),t.getBoundingClientRect()];return n.right>e.left&&n.left<e.right&&n.bottom>e.top&&n.top<e.bottom?(Pt(t),!0):!1},rt=()=>{const t=document.getElementById("trashModal");t.classList.toggle("visible")?(t.style.display="block",requestAnimationFrame(()=>Et())):setTimeout(()=>{window.AnimationUtils?window.AnimationUtils.updateStyles(t,{display:"none"},"normal"):t.style.display="none"},300)},Et=()=>{const t=$(".deleted-notes-container");window.AnimationUtils?window.AnimationUtils.updateStyles(t,{minHeight:"200px"},"normal"):t.style.minHeight="200px",t.innerHTML=D.length?D.map((e,n)=>`
