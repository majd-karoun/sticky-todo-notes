(()=>{const nt=["#f0e68c","#98ff98","#ff7eb9","#7afcff","#FE8801","#ec0c39","#AF65EF","#ffd700","#C1C1C1","#FFFFFF"],A={colors:{default:"#1a1a1a",current:"#1a1a1a",available:["#1a1a1a","#500000","#004000","#000050","#10253F","#400040"]},patterns:{default:"none",current:"none"}};let U=[];let V=null,Ut=null,dt=!1,Z=null,ut=0,mt=0,w=[],st=!1,Kt=0,Jt=0,F=[];const K={},Q={},X={};let H=1e3;K[1]={x:window.innerWidth/2-100,y:window.innerHeight/2-75};Q[1]=nt[0];let m=1,T=1,G=!1;const et=9,ft="stickyNotes_active",Vt="stickyNotes_deleted",Zt="stickyNotes_boardCount",Gt="stickyNotes_zIndexes",Qt=()=>{G=window.innerWidth<=768,G&&m!==1&&typeof Y=="function"&&Y(1)},S=t=>parseInt(String(t).replace("px",""))||0,Ot=(t,e)=>{const o=Math.random()*10-5;let n=t+o,a=e+70;const s=5,r=window.innerWidth-200,i=window.innerHeight-300;a>i&&(a=50,n=t+250,n>r&&(n=s+50,a=50));const l=Math.min(Math.max(n,s),r),f=Math.min(Math.max(a,s),window.innerHeight-100);return{x:l,y:f}},we=t=>{if(t.startsWith("rgba")){const o=t.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)/);return o?{r:parseInt(o[1]),g:parseInt(o[2]),b:parseInt(o[3])}:null}t=t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,(o,n,a,s)=>n+n+a+a+s+s);const e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null},Bt=(t,e)=>{try{localStorage.setItem(t,JSON.stringify(e))}catch(o){console.error(`Failed to save to localStorage (${t}):`,o)}},J=()=>{const t=document.querySelector(`.board[data-board-id="${m}"]`);if(!t)return;const e=Array.from(t.querySelectorAll(".sticky-note")).map(o=>({text:o.querySelector(".sticky-content").innerHTML,color:o.style.backgroundColor,x:o.style.left,y:o.style.top,width:o.style.width||"200px",height:o.style.height||"150px",isBold:o.querySelector(".sticky-content").classList.contains("bold"),noteId:o.dataset.noteId,zIndex:o.style.zIndex||1}));Bt(`${ft}_board_${m}`,e),typeof z=="function"&&z()},Nt=()=>Bt(Vt,U),te=()=>localStorage.setItem(Zt,T.toString()),ee=()=>Bt(`boardStyles_board_${m}`,{color:A.colors.current,pattern:A.patterns.current}),oe=()=>{const t=document.getElementById("shortcutIcon");if(!t)return;const e=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl";t.innerHTML=e,t.className="shortcut-icon focus-hint"},ne=()=>{const t=document.querySelector(".note-input textarea");if(!t)return;const e=document.getElementById("shortcutIcon"),o=()=>{if(!e)return;const n=navigator.platform.toUpperCase().indexOf("MAC")>=0?"\u2318":"Ctrl",a=t.value.trim();e.innerHTML=a?`${n}+\u21B5`:n,e.classList.toggle("focus-hint",!a),e.classList.toggle("enter-hint",a)};t.addEventListener("focus",()=>{o(),t.style.height="50px",requestAnimationFrame(()=>t.style.height="200px"),t.addEventListener("input",o)}),t.addEventListener("blur",()=>{oe(),t.style.height="200px",requestAnimationFrame(()=>t.style.height="50px"),t.removeEventListener("input",o)}),document.addEventListener("mousedown",n=>{!n.target.closest(".note-input")&&document.activeElement===t&&t.blur()})},Pt=(t,e=null)=>{try{return JSON.parse(t)}catch(o){return console.error("Failed to parse JSON data:",o),e}},ke=()=>{const t="stickyNotes_storageCleanupPerformed";if(!localStorage.getItem(t))try{console.log("Performing one-time localStorage cleanup...");const e=[];for(let o=0;o<localStorage.length;o++){const n=localStorage.key(o);n&&(n.startsWith("stickyNotes_")||n.startsWith("boardColor_")||n.startsWith("boardPattern_")||n.startsWith("boardStyles_")||n.startsWith("emojiStickers_")||n.startsWith("daysPatternStartDate_")||n.startsWith("emojiUsageOrder"))&&e.push(n)}e.forEach(o=>{localStorage.removeItem(o)}),console.log(`Cleaned up ${e.length} localStorage items`),localStorage.setItem(t,"true")}catch(e){console.error("Error during localStorage cleanup:",e),localStorage.setItem(t,"true")}},Ce=()=>{try{ke(),Qt(),typeof _t=="function"&&_t();const t=localStorage.getItem(Zt);if(t){const o=parseInt(t);if(!isNaN(o)&&o>0){T=Math.min(o,et);for(let n=2;n<=T;n++)typeof qt=="function"&&qt(n)}}typeof bt=="function"&&bt();for(let o=1;o<=T;o++){const n=localStorage.getItem(`${ft}_board_${o}`);if(n){const a=Pt(n,[]);Array.isArray(a)&&a.forEach(s=>{if(s&&typeof s=="object"&&s.text&&(K[o]={x:S(s.x),y:S(s.y)},Q[o]=s.color||nt[0],typeof Ct=="function")){const r=Ct(s.text,s.color||nt[0],S(s.x),S(s.y),!0,s.width||"200px",s.height||"150px",s.isBold||!1,o);r&&s.noteId&&(r.dataset.noteId=s.noteId,X[s.noteId]?(r.style.zIndex=X[s.noteId],X[s.noteId]>H&&(H=X[s.noteId])):s.zIndex&&!isNaN(parseInt(s.zIndex))&&(r.style.zIndex=s.zIndex,X[s.noteId]=parseInt(s.zIndex),parseInt(s.zIndex)>H&&(H=parseInt(s.zIndex))))}})}typeof ct=="function"&&ct(o)}typeof Y=="function"&&Y(1);const e=localStorage.getItem(Vt);if(e){const o=Pt(e,[]);Array.isArray(o)&&(U=o,typeof at=="function"&&at())}["updateBoardIndicators","updateShortcutHintVisibility"].forEach(o=>{typeof window[o]=="function"&&window[o]()}),oe(),ne()}catch(t){console.error("Critical error loading saved data:",t)}},Te=t=>{t.style.zIndex=++H;const e=t.dataset.noteId;e&&(X[e]=H,se())},se=()=>{try{localStorage.setItem(Gt,JSON.stringify(X))}catch(t){console.error("Error saving note z-indexes:",t)}},$e=()=>{try{const t=localStorage.getItem(Gt);t&&(Object.assign(X,JSON.parse(t)),H=Math.max(1e3,...Object.values(X)))}catch(t){console.error("Error loading note z-indexes:",t)}};const _t=()=>{Z=Object.assign(document.createElement("div"),{className:"selection-box"}),Object.assign(Z.style,{display:"none"}),document.body.appendChild(Z)};function qe(){const t=document.querySelector(".boards-container");document.addEventListener("mousedown",e=>{e.target.closest(".board")&&!e.target.closest(".sticky-note, .note-input, .boards-navigation, .trash-bin, .board-style-button")&&e.preventDefault()}),[["mousedown",Be],["mousemove",Ne],["mouseup",Me]].forEach(([e,o])=>(e==="mousedown"?t:document).addEventListener(e,o))}function Be(t){if(t.target.closest(".sticky-note, .note-input, .trash-bin, .boards-navigation, .board-style-button, .emoji-sticker"))return;t.preventDefault();const e=document.querySelector(".note-input textarea");e&&document.activeElement===e&&e.blur(),!t.shiftKey&&St(),[dt,ut,mt]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),Z.style.cssText=`left:${ut}px; top:${mt}px; width:0; height:0; display:block;`}function Ne(t){if(!dt)return;t.preventDefault();const[e,o]=[Math.abs(t.clientX-ut),Math.abs(t.clientY-mt)],[n,a]=[Math.min(t.clientX,ut),Math.min(t.clientY,mt)];Z.style.cssText=`left:${n}px; top:${a}px; width:${e}px; height:${o}px; display:block;`,Ie()}const Me=()=>{dt&&(dt=!1,document.body.classList.remove("selecting"),Z.style.display="none")};function Ie(){const t=Z.getBoundingClientRect(),e=document.querySelector(`.board[data-board-id="${m}"]`);if(!e)return;const o=(n,a,s)=>{const r=n.getBoundingClientRect(),i=!(r.right<t.left||r.left>t.right||r.bottom<t.top||r.top>t.bottom),l=a.indexOf(n);i?l===-1&&(a.push(n),n.classList.add(s)):!st&&l!==-1&&(a.splice(l,1),n.classList.remove(s))};e.querySelectorAll(".sticky-note").forEach(n=>o(n,w,"selected"))}const St=()=>{w.forEach(t=>t.classList.remove("selected")),w=[]};function Ae(t){[st,Kt,Jt]=[!0,t.clientX,t.clientY],document.body.classList.add("selecting"),F=w.map(e=>({element:e,x:S(e.style.left),y:S(e.style.top),type:"note"})),["mousemove","mouseup"].forEach(e=>document.addEventListener(e,e==="mousemove"?ae:re))}function ae(t){if(!st)return;const[e,o]=[t.clientX-Kt,t.clientY-Jt],[n,a,s]=[5,-5,-5],[r,i]=[window.innerWidth-n,window.innerHeight-n];(f=>f.forEach(d=>{const[g,h]=[Math.min(Math.max(d.x+e,a),r-d.element.offsetWidth/4),Math.min(Math.max(d.y+o,s),i-d.element.offsetHeight/4)];Object.assign(d.element.style,{left:`${g}px`,top:`${h}px`})}))(F),w.length>0&&(le(t.clientX,t.clientY),w.length>1&&At())}function re(){if(!st)return;if(st=!1,document.body.classList.remove("selecting"),["mousemove","mouseup"].forEach(e=>document.removeEventListener(e,e==="mousemove"?ae:re)),it(),!ue().moved){J();for(let e=w.length-1;e>=0;e--)ie(w[e])&&w.splice(e,1)}Dt()}let ot=[];const De=100,Xt=50,Re="#ffd700",Ye=t=>{w.includes(t)&&w.length>1?(w.forEach((e,o)=>setTimeout(()=>kt(e),o*100)),St()):kt(t)},kt=t=>{if(U.length>De)return!ot.includes(t)&&ot.push(t),Xe();const e=t.querySelector(".sticky-content"),o={text:e.innerHTML,color:t.style.backgroundColor,x:t.style.left,y:t.style.top,width:t.style.width,height:t.style.height,timestamp:new Date().toLocaleString(),isBold:e.classList.contains("bold")};je(t),U.unshift(o),Nt(),at(),Oe(t)},je=t=>{if(!window.noteColumns)return;const e=t.closest(".board");if(!e||!e.matches(".board-pattern-weekdays, .board-pattern-days"))return;const[o,n]=[e.getBoundingClientRect(),t.getBoundingClientRect()],a=Math.min(5,Math.max(0,Math.floor((n.left+n.width/2-o.left)/(o.width/6))));window.noteColumns[a]&&(window.noteColumns[a]=window.noteColumns[a].filter(s=>Math.abs(s.x-S(t.style.left))>1||Math.abs(s.y-S(t.style.top))>1))},Oe=t=>{const e=document.querySelector(".trash-bin"),o=e.getBoundingClientRect(),n=t.getBoundingClientRect(),a=o.left-n.left+o.width/2-n.width/2,s=o.top-n.top;t.style.setProperty("--throwX",`${a}px`),t.style.setProperty("--throwY",`${s}px`),t.style.animation="paperCrumble 0.5s ease-in forwards",e.style.animation="binShake 0.5s ease-in-out",setTimeout(()=>{t.remove(),e.style.animation="",J(),z()},500)},ie=t=>{const[e,o]=[document.querySelector(".trash-bin").getBoundingClientRect(),t.getBoundingClientRect()];return o.right>e.left&&o.left<e.right&&o.bottom>e.top&&o.top<e.bottom?(Ye(t),!0):!1},yt=()=>{const t=document.getElementById("trashModal");t.classList.toggle("visible")?(t.style.display="block",requestAnimationFrame(()=>ht())):setTimeout(()=>t.style.display="none",300)},ht=()=>{const t=document.querySelector(".deleted-notes-container");t.innerHTML=U.length?U.map((e,o)=>`
